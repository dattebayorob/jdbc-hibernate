...
public class CursoDao {
	...
	public Curso findById(long id) {
		...
		try {
			Curso instance = (Curso) sessionFactory.getCurrentSession().get("com.dtb.jdbc.model.Curso", id);
			if (instance == null) {
	...
	public List findByExample(Curso instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.dtb.jdbc.model.Curso")
