 ...
 * @see com.dtb.jdbc.model.Pagamento
...
public class PagamentoDao {
	...
	public Pagamento findById(long id) {
		...
		try {
			Pagamento instance = (Pagamento) sessionFactory.getCurrentSession().get("com.dtb.jdbc.model.Pagamento", id);
			if (instance == null) {
	...
	public List findByExample(Pagamento instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.dtb.jdbc.model.Pagamento")
